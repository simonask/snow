...
CAPI VALUE snow_invoke_parallel_threads(struct SnArray* functions, struct SnContext* context) ATTR_HOT;
CAPI VALUE snow_invoke_parallel_forks(struct SnArray* functions, struct SnContext* context)   ATTR_HOT;
