...
#define snow_define_method(KLASS, NAME, FUNCTION) _snow_define_method(KLASS, NAME, FUNCTION, #FUNCTION, true)
#define snow_define_method_nocc(KLASS, NAME, FUNCTION) _snow_define_method(KLASS, NAME, FUNCTION, #FUNCTION, false)
#define snow_define_class_method(KLASS, NAME, FUNCTION) _snow_define_class_method(KLASS, NAME, FUNCTION, #FUNCTION, true)
#define snow_define_class_method_nocc(KLASS, NAME, FUNCTION) _snow_define_class_method(KLASS, NAME, FUNCTION, #FUNCTION, false)
